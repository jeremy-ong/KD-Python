...
range_: intRange | longRange | floatRange | doubleRange | decimalRange | durationRange | dateTimeRange | versionRange
...
list_: ('[' NL* value (COMMA? NL* value)* NL* ']') | ('[' ']');

pair: NL* value '=' NL* value NL*;

map_: ('[' NL* pair (COMMA? NL* pair)* NL* ']') | ('[' '=' ']');
